      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-8 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
        ...
        <div className="flex flex-col">
          <Link href="/publicar-empleo" className="flex items-center space-x-2 text-muted-foreground hover:text-black transition-colors mb-24">
            ...
            <span className="font-sans text-[10px] tracking-widest uppercase">Volver</span>
          </Link>
          
          <h1 className="font-serif text-6xl md:text-[8rem] tracking-tighter leading-none mb-16 uppercase">
            RESUMEN
          </h1>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center py-4">
              <span className="font-sans text-[10px] tracking-widest text-muted-foreground uppercase mb-2">
                Ítem
              </span>
              <p className="font-serif italic text-3xl md:text-4xl tracking-tight">
          ...
          <div className="mt-24">
            ...
            <div className="bg-white border border-border p-6 w-full max-w-xs transform -rotate-2 hover:rotate-0 transition-transform duration-300">
              <span className="font-sans text-[8px] tracking-[0.2em] uppercase text-muted-foreground mb-2 block">Oferta de Empleo</span>
              <h3 className="font-serif text-2xl tracking-tight mb-1">Tatuador</h3>
              <p className="font-sans text-xs text-muted-foreground">en Black Lung Studio</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white border border-border w-full">
            ...
            <div className="grid grid-cols-2 border-b border-border">
              <div className="p-8 md:p-12 border-r border-border flex flex-col justify-center">
                <span className="font-sans text-[10px] tracking-widest text-muted-foreground uppercase mb-2">Subtotal</span>
                <span className="font-serif text-3xl">$150</span>
              </div>
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <span className="font-sans text-[10px] tracking-widest text-muted-foreground uppercase mb-2">Impuestos</span>
                <span className="font-serif text-3xl text-muted-foreground">$0.00</span>
              </div>
            </div>
            
            {/* Total row */}
            <div className="p-8 md:p-12 border-b border-border bg-gray-50/50">
              <span className="font-sans text-[10px] tracking-widest text-muted-foreground uppercase mb-2 block">Total</span>
              <span className="font-serif text-6xl md:text-7xl tracking-tighter">$150</span>
            </div>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="border border-dashed border-border p-8 mb-8 flex flex-col items-center justify-center text-center text-muted-foreground">
                ...
                <span className="font-sans text-[10px] tracking-[0.2em] uppercase max-w-[200px] leading-relaxed">
