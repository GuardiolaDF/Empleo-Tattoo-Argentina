  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-4 py-24 md:px-8">
        ...
        <h1 className="font-serif text-6xl md:text-[6rem] tracking-tighter leading-none mb-6">
          GUÍA DEL ARTISTA
        </h1>
        <p className="font-serif italic text-2xl md:text-3xl text-muted-foreground mb-16">
          Cómo encontrar tu próximo estudio en ETA
        </p>

        <hr className="border-black/10 mb-16" />

        <p className="font-sans text-lg leading-relaxed text-foreground mb-24 max-w-3xl">
        ...
        <div className="space-y-16">
          <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
            <span className="font-serif text-5xl md:text-6xl text-muted-foreground/30">01</span>
            <div>
              <h3 className="font-sans text-lg tracking-widest uppercase font-bold mb-4">PREPARA TU PORTFOLIO</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
            <span className="font-serif text-5xl md:text-6xl text-muted-foreground/30">02</span>
            <div>
              <h3 className="font-sans text-lg tracking-widest uppercase font-bold mb-4">IDENTIFICA TU ROL IDEAL</h3>
              <p className="font-sans text-base leading-relaxed text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
            <span className="font-serif text-5xl md:text-6xl text-muted-foreground/30">03</span>
            <div>
              <h3 className="font-sans text-lg tracking-widest uppercase font-bold mb-4">UTILIZA LOS FILTROS DE ETA</h3>
              <p className="font-sans text-base leading-relaxed text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
            <span className="font-serif text-5xl md:text-6xl text-muted-foreground/30">04</span>
            <div>
              <h3 className="font-sans text-lg tracking-widest uppercase font-bold mb-4">EL PRIMER CONTACTO</h3>
              <p className="font-sans text-base leading-relaxed text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-8">
            <span className="font-serif text-5xl md:text-6xl text-muted-foreground/30">05</span>
            <div>
              <h3 className="font-sans text-lg tracking-widest uppercase font-bold mb-4">MANTENTE ACTUALIZADO</h3>
              <p className="font-sans text-base leading-relaxed text-foreground">
        ...
        <div className="mt-32 pt-16 border-t border-black text-center">
          <h2 className="font-serif text-3xl md:text-4xl mb-6">¿Tenés alguna duda?</h2>
          <p className="font-sans text-foreground mb-8">
            Estamos acá para ayudarte a navegar la industria.
          </p>
          <a href="mailto:hola@fabiguardiola.com" className="inline-block bg-black text-white px-8 py-4 font-sans text-xs tracking-widest uppercase hover:bg-black/80 transition-colors">
            Contactar a Soporte
          </a>
        </div>
      </main>
