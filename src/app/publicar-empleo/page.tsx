            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <select 
                  ...
                  className={`border ${errors.especialidades ? 'border-red-500' : 'border-border'} px-4 py-3 outline-none font-sans text-sm focus:border-black transition-colors bg-white appearance-none`}
                >
          ...
          <section className="bg-muted p-8 md:p-12 space-y-8">
            <div className="flex justify-between items-center pb-6">
              <div>
                ...
                <p className="font-sans text-xs text-muted-foreground max-w-sm leading-relaxed">Tu anuncio queda publicado de forma permanente. Podés editar la información durante los primeros 30 días. Incluye mención en newsletter.</p>
              </div>
              <div className="text-right">
                <h3 className="font-serif text-5xl tracking-tighter leading-none">$ 20.000</h3>
              </div>
            </div>
            ...
            >
              <span className="font-sans text-xs tracking-widest uppercase">PUBLICAR UN EMPLEO</span>
            </button>
          </section>
