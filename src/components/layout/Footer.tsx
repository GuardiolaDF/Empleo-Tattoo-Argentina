    ...
    <footer className="bg-black text-white py-20 px-4 md:px-8">
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex flex-wrap gap-8 md:gap-16 font-sans text-[10px] tracking-[0.2em] uppercase text-white/70">
          ...
          <div className="flex flex-col space-y-4">
            <a href="mailto:hola@fabiguardiola.com" className="hover:text-white transition-colors leading-relaxed">Mail</a>
            <a href="https://www.linkedin.com/in/fabiguardiola/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors leading-relaxed">LinkedIn</a>
          </div>
        </div>
      </div>
    </footer>
